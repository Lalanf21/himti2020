...
class Visi_misi extends CI_controller{
	...
	{	
        $data['value'] = $this->logic->get_all($this->table)->result();
        $data['title'] = 'HIMTI | Visi-Misi';
		$data['konten'] = 'back-end/tentang_himti/visi_misi';
    ...
    public function add() { 
        ...
        if( $this->form_validation->run() === false ){
            ...
            $visiMisi = htmlspecialchars(htmlentities($this->input->post('visiMisi',true)));

            $data = ['visi_misi'=> $visiMisi];
    ...
    public function update() { 
        ...
        $visiMisi = htmlspecialchars(htmlentities($this->input->post('visiMisi')));
